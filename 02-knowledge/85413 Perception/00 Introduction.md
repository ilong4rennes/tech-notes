...
- Neural activity provides _cues_ → brain decodes the world.
- Leads to:
    - Updating mental representation: _What’s out there? Where is it?_
...
1. **Do we perceive reality as it really is?**
    - No, perception is not veridical. It makes _guesses_ using heuristics.
    - Illusions (size, shape, motion) reveal perceptual rules.
    - _Bayesian model_: brain predicts future states from current sensory data/statistics (e.g., tunnel illusion).
